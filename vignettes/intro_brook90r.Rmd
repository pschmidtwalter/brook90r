...
roots_constant <- MakeRelRootDens(soilnodes = soil_slb1$lower, 
                              ...
                              method = options.b90$root.method,
                              relrootden = 0.2)
plot(roots_beta, soil_slb1$lower, type = 's', lwd = 1.5,
     ylab = "soil depth [m]", xlim = c(0,0.35))
lines(roots_table/100, soil_slb1$lower, type = 's', lty= 2, lwd = 1.5)
lines(roots_linear, soil_slb1$lower, type = 's', lty= 3, lwd = 1.5)
lines(roots_constant, soil_slb1$lower, type = 's', lty= 4, lwd = 1.5)
```
