...
```{r, fig.height=4, fig.width=7, echo =F, fig.cap="Simulation results for sample data"}
...
```{r,echo = 1:5, results = 'hide',fig.height=4, fig.width=7, fig.cap = "Options and parameters affecting interannual variation of leaf area index."}
...
```{r,echo = F, fig.height=4, fig.width=7, fig.cap="Interpolated stand height derived from parameters using approx_standprop()"}
