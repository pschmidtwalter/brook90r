...
#' @return returns a list with model parameters to use as input for Run.B90
#' @details
#' \tabular{llcl}{
...
#'  optdoy       \tab day of year when optimum value is reached - passed to MakeSeasLAI. Default: 210 \tab doy               \tab Plant                  \cr
#'  sai          \tab steam area index. Default: 1 \tab -                 \tab Plant                  \cr
#'  shapeend     \tab Shape parameter for leaf fall phase - passed to MakeSeasLAI. Default: 0.3\tab -                  \tab Plant                  \cr
#'  shapestart   \tab shape parameter for leaf growth phase - passed to MakeSeasLAI. Default: 3\tab -                  \tab Plant                  \cr
...
#'  age          \tab Age of stand (for root development). Default: 100\tab a                 \tab Water supply           \cr
